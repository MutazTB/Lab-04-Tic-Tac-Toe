...
namespace TicTacToeTest
{
    public class UnitTest1
    {
        ...
        public void SwitchesPlayer()
        {
            ...
            Game testGame = new Game(playerOne, playerTwo);
            testGame.PlayerTwo.IsTurn = true;
            testGame.SwitchPlayer();

            Assert.Equal(testGame.PlayerOne, testGame.NextPlayer());
        }
        ...
        public void CorrectIndex()
        {
            ...
            Assert.Equal(new int[] { 0, 1 }, new int[] { testPosition.Row, testPosition.Column });
        }
